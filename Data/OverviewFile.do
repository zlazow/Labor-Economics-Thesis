...
areg scorerd handicap hand_i , $options
est store baseline

foreach var of varlist hand_max hand_min hand_top1 hand_top5 hand_top10 hand_top25 hand_bot25 hand_bot10 tigeringrp {
...
foreach var of varlist hand_max hand_min hand_top1 hand_top5 hand_top10 hand_top25 hand_bot25 hand_bot10 tigeringrp {
 areg scorerd handicap hand_i hand_iXdiff `var', $options 
 est store `var'
}

areg scorerd handicap hand_i hand_iXdiff, $options
est store diff

estout * using ${PATH}table6.txt, drop(_*) ///
